...
export default function DatabaseCard({ slug, title }: DatabaseCardProps) {
  ...
  return (
    <Link
      href={`/${slug}`}
      className="group flex flex-col items-center justify-center p-8 bg-gray-50 dark:bg-gray-300 rounded-lg shadow-md border border-gray-200 transition-all duration-300 hover:shadow-xl hover:bg-blue-50 hover:-translate-y-1"
    >
